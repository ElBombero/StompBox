...
static Midi::PercussionKey Midi::ChangePercussion(Midi::PercussionKey oldKey, Midi::PercussionChange operation) {
...
static void Midi::GetPercussionName(Midi::PercussionKey key, char* bufferOut, size_t bufferSize) {
    char buffer[32];
    switch(key) {
